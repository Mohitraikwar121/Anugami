...
## 🔐 Security & Privacy
ANUGAMI should handle location-related information responsibly. User location data should only be accessed when required and with appropriate user permission.
